...
|--------------------------------------------------------------------------
|
| Need to manually install ts-loader in the root of your project for 
| typescript loader to work. Separate configuration file can be defined.
| Useful when need to use DOM or DOM.Iterable lib. But it works without
| defining separate tsconfig.json
|
*/
...
// Encore.configureLoaderRule('ts-loader', (rule) => {
//   rule.configFile = './resources/frontend/tsconfig.json'
// })
